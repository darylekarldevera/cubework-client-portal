  ...
  return (
    <>
      ...
      <div className="mt-[20px] pl-[10px]">
        <ShadCNLabel className="text-cb-text leading-relaxed text-cw-gray font-bold ">
      ...
      <div className="flex items-center justify-between px-[10px]">
        <div className="flex gap-1">
          ...
          <ShadCNLabel id="terms" className="text-cb-text leading-relaxed text-cw-gray font-bold ">
